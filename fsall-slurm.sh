...
#SBATCH -o rplfsall.%N.%j.out # STDOUT
#SBATCH -e rplfsall.%N.%j.err # STDERR
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:489115647377:awsnotify --message "FSJobDone"
